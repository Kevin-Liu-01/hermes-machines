		...
		"@graph": [
			...
			},
			{
				...
				featureList: [
					...
					"Dedalus, Vercel Sandbox, and Fly Machines providers",
					"OpenAI-compatible /v1/chat/completions endpoint",
					"95 SKILL.md skills auto-loaded by intent",
					"17 MCP service integrations (Vercel, Stripe, Supabase, Linear, GitHub, Slack, PostHog, Sentry, Clerk, Firebase, Figma, Shopify, ClickHouse, Datadog, AWS, Cloudflare, model providers)",
					"23 built-in agent tools (shell, filesystem, browser, vision, code, memory, schedule, search)",
					"Cursor SDK delegation for code edits",
					"Sleep / wake by the second; ~30s cold boot, <5s warm",
